			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
						<form:form class="card" action="/submit_aggiungi_attivita"
							method="POST" modelAttribute="attivita">
								...
								<div class="row">
									<div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
										<div class="form-group">
											...
											<form:input type="text" name="nome_attivita"
												class="form-control ${valid_nomeAttivita}"
												path="nomeAttivita"></form:input>
										...
										<div class="form-group">
											...
											<div class="row gutters-xs">
												<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
													<form:select name="giorno_svolgimento"
														class="form-control custom-select ${valid_giorno}"
														path="giorno_svolgimento">
												...
												<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
													<form:select name="mese_svolgimento"
														class="form-control custom-select ${valid_mese}"
														path="mese_svolgimento">
												...
												<div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
													<form:select name="anno_svolgimento"
														class="form-control custom-select ${valid_anno}"
														path="anno_svolgimento">
										...
										<div class="form-group">
											...
											<div class="row gutters-xs">
												<div class="col-sm-12 col-md-5 col-lg-4 col-xl-4">
													<form:select name="ora_svolgimento"
														class="form-control custom-select ${valid_ora}"
														path="ora_svolgimento">
												...
												<div class="col-sm-12 col-md-5 col-lg-4 col-xl-4">
													<form:select name="minuto_svolgimento"
														class="form-control custom-select ${valid_minuto}"
														path="minuto_svolgimento">
								...
								<div class="row">
									<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
										<div class="form-group">
											...
											<form:input type="text" name="nome_professore"
												class="form-control ${valid_nomeProf}" path="nomeProfessore"></form:input>
									...
									<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
										<div class="form-group">
											...
											<form:input type="text" name="cognome_professore"
												class="form-control ${valid_cognomeProf}"
												path="cognomeProfessore"></form:input>
