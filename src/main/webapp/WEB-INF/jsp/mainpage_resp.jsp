                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg order-lg-first">
                                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                                    <li class="nav-item">
                                        <a href="./mainpage_resp" class="nav-link active"><i class="fe fe-home"></i> Home</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">Nome Attività</h3>
                                        <div class="card-options">
                                            <a href="./scheda_attivita" class="btn btn-primary btn-sm">Apri</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
